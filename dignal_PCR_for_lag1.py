...
from queue import Queue
 ...
 配置参数
input_dir = "4147_LP_fna"
output_dir = "dignal_PCR_results"
output_file = os.path.join(output_dir, "pcr_results_sg1_lag1.xlsx")
forward_primer = "CTCACAACAAGTCAAGCAAC"
reverse_primer = "AAACCATACCAAAGCAACAT"
max_mismatch = 6
min_tm = 40.0
min_product_length = 500
max_product_length = 600
