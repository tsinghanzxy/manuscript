# -*- coding: utf-8 -*-
"""
此脚本用于分析293T细胞系在感染嗜肺军团菌后的多项指标数据，并分为
...
output_dir = Path('293T_analysis_plots')
...
# 加载数据集
try:
    # 假设CSV文件名是 293T_PCA.csv
    df = pd.read_csv('293T_PCA.csv', encoding='gbk') 
except FileNotFoundError:
    print("错误: '293T_PCA.csv' 未找到。请确保该文件与脚本在同一目录下。")
    exit()
...
def parse_isolate_name(name):
    # 根据293T_PCA.csv文件的Isolate_Name格式，例如 'Low_probability01'
...
# 保存PCA图
pca_plot_filename = output_dir / '293T_PCA_with_Ellipse_and_Stats.pdf'
